            ...
            ui.createComponent('product', {
                ...
                options: {
                    ...
                    product: {
                        ...
                        templates: {
                            button: `
                                <button  data-element="product.button" class="shopify-buy__btn group select-none cursor-pointer flex items-center gap-2.5 ${textClasses} text-[var(--foreground)] hocus:text-[var(--foreground)] mt-2xs">
                                    <div class="transition-all rounded-full group-hover:w-full absolute top-0 left-0 ${widthClasses} bg-[var(--foreground)]"></div>
                                    <div class="relative ${widthClasses} rounded-full flex flex-wrap transition-transform group-hover:[transform:rotateX(180deg)] content-center">
